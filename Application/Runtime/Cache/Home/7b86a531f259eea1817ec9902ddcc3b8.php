		...
		<!--标题-->
        	<div class="p10">
                   <h1 class="p10">
                        ...
                        <span class="left mr10 c_z" style="width:600px;text-align:center;">答卷时间：<span id="minutes"><?php echo ($minutes); ?></span>:<span id="seconds"><?php echo ($seconds); ?></span></span>
								...
								<div class="x_con">
			                    	...
			                    	<p>
			                    		<?php $k = 0; foreach($options as $k=>$val){ ?>
			                    			<p ><label><input type="radio" name="<?php echo ($vo["id"]); ?>" value="<?php echo $options_index[$k] ?>"> <?php echo $options_index[$k] ?>.<?php echo $val ?></label></p>
			                    		<?php } ?>
			                    		
			                    	</p>
			                    	<?php } ?>
			                    	
									<p>选择答案：<font color="#FF6600" id="<?php echo ($vo["id"]); ?>"></font></p>
								</div>

    ...
    <form class="form form-horizontal" action="<?php echo U('/admin/admin/login');?>" method="post">
      ...
      <div class="row cl">
        <div class="formControls col-8 col-offset-3">
          ...
          <img id="verify" onclick="$(this).attr('src','/index.php/admin/admin/verifyCode?'+Math.random());" src="<?php echo U('/admin/admin/verifyCode');?>" width="70px" height="35px"> <a id="kanbuq" href="javascript:;" onclick="$('#verify').attr('src','/index.php/admin/admin/verifyCode?'+Math.random());" href="javascript:;">看不清，换一张</a> </div>
      </div>
      <!-- <div class="row">
        <div class="formControls col-8 col-offset-3">
          <label for="online">
...
<div class="footer">Copyright 哈学库</div>

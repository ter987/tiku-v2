...
<body>
<header class="Hui-header cl"> <a class="Hui-logo l" title="H-ui.admin v2.3" href="/index.php/admin">后台管理系统</a> 
	...
	<ul class="Hui-userbar">
		<li><?php echo ($admin_info["title"]); ?></li>
		<li class="dropDown dropDown_hover"><a href="#" class="dropDown_A"><?php echo ($admin_info["user_name"]); ?> <i class="Hui-iconfont">&#xe6d5;</i></a>
			<ul class="dropDown-menu radius box-shadow">
				<li><a href="#">个人信息</a></li>
				<li><a href="#">切换账户</a></li>
...
<aside class="Hui-aside">
	...
	<div class="menu_dropdown bk_2">
		...
		<dl id="menu-product">
			...
			<dd>
				<ul>
					<li><a _href="<?php echo U('admin/tiku/index');?>" href="javascript:void(0)">题库管理</a></li>
					<li><a _href="<?php echo U('admin/tikusource/index');?>" href="javascript:void(0)">试卷管理</a></li>
					<li><a _href="<?php echo U('admin/tikupoint/index');?>" href="javascript:void(0)">知识点管理</a></li>
				</ul>
			</dd>
		</dl>
		<!--<dl id="menu-page">
		...
		<dl id="menu-member">
			...
			<dd>
				<ul>
					<li><a _href="<?php echo U('admin/member/index');?>" href="javascript:;">会员列表</a></li>
		...
		<dl id="menu-admin">
			...
			<dd>
				<ul>
					<li><a _href="<?php echo U('admin/Admin/role');?>" href="javascript:void(0)">角色管理</a></li>
					<!-- <li><a _href="<?php echo U('admin/Admin/rule');?>" href="javascript:void(0)">权限管理</a></li> -->
		...
		<dl id="menu-system">
			...
			<dd>
				<ul>
					<!-- <li><a _href="/index.php?m=admin&c=updatecache" href="javascript:void(0)">更新缓存</a></li>
					...
					<li><a _href="<?php echo U('admin/system/readlog');?>" href="javascript:void(0)">系统日志</a></li>
					<li><a _href="<?php echo U('admin/system/report');?>" href="javascript:void(0)">系统报表</a></li>
				</ul>
			</dd>
		</dl>
	</div>
